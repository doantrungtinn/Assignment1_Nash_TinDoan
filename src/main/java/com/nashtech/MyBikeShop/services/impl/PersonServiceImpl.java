...
public class PersonServiceImpl implements PersonService {
	...
	public person createPerson(PersonDTO personDTO) {
		...
		if (person.isPresent()) {
			...
			com.nashtech.MyBikeShop.model.person personEntity = new person(personDTO);
...
//		person.setRole(personEntity.getRole());
		...
		if (checkEmailChange) { // Không đổi email
			...
			List<com.nashtech.MyBikeShop.model.person> list = personRepository.findByEmailIgnoreCase(personDTO.getEmail());
			if (list.isEmpty()) {
				personRepository.save(person);
			} else {
