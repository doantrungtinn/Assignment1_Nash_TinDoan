...
public class orderdetail {
	...
	@JsonBackReference
	private com.nashtech.FutsalShop.model.order order;

	@ManyToOne
	@JsonBackReference
	@JoinColumn(name = "productid", insertable = false, updatable = false)
	private com.nashtech.FutsalShop.model.product product;
	...
	public orderdetail(OrderDetailsKey id, int ammount, double unitPrice, com.nashtech.FutsalShop.model.order order, com.nashtech.FutsalShop.model.product product) {
		super();
		this.id = id;
		this.ammount = ammount;
		this.order = order;
	...
	public com.nashtech.FutsalShop.model.order getOrder() {
		return order;
	}

	public void setOrder(com.nashtech.FutsalShop.model.order order) {
		this.order = order;
	}

	public com.nashtech.FutsalShop.model.product getProduct() {
		return product;
	}

	public void setProduct(com.nashtech.FutsalShop.model.product product) {
		this.product = product;
	}
